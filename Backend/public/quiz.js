...
const schoolSubjects = {
  "Class 1":["Math","English","Science","EVS"],
  "Class 2":["Math","English","Science","EVS"],
  "Class 3":["Math","English","Science","EVS"],
  "Class 4":["Math","English","Science","Social Studies"],
  "Class 5":["Math","English","Science","Social Studies"],
  "Class 6":["Math","English","Science","Social Studies"],
  "Class 7":["Math","English","Science","Social Studies"],
  "Class 8":["Math","English","Science","Social Studies"],
...
function showStep(step) {
  [step1, step2, step3, step4, step5].forEach(s => s.style.display = 'none');
...
async function loadQuiz(subject, amount, type, difficulty) {
  ...
  try {
    ...
    if (currentQuiz.length === 0) {
      questionsContainer.innerHTML = 'No questions found. Please try different settings.';
      return;
    }
    ...
    console.error(err);
    questionsContainer.innerHTML = 'Failed to load questions. Check your internet connection.';
  }
}
